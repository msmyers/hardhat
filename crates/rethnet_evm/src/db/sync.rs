    ...
    E: Debug + Send + 'static,
{
    ...
    pub async fn account_by_address(
        &self,
        address: Address,
    ) -> Result<Option<AccountInfo>, <D as Database>::Error> {
    ...
    pub async fn account_storage_slot(
        &self,
        address: Address,
        index: U256,
    ) -> Result<U256, <D as Database>::Error> {
        let (sender, receiver) = oneshot::channel();
    ...
    pub async fn block_hash_by_number(&self, number: U256) -> Result<H256, <D as Database>::Error> {
        let (sender, receiver) = oneshot::channel();
    ...
    pub async fn checkpoint(&self) -> Result<(), <D as Database>::Error> {
        let (sender, receiver) = oneshot::channel();
    ...
    pub async fn code_by_hash(&self, code_hash: H256) -> Result<Bytecode, <D as Database>::Error> {
        let (sender, receiver) = oneshot::channel();
    ...
    pub async fn revert(&self) -> Result<(), <D as Database>::Error> {
        let (sender, receiver) = oneshot::channel();
    ...
    pub async fn storage_root(&self) -> Result<H256, <D as Database>::Error> {
        let (sender, receiver) = oneshot::channel();
